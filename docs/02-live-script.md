...
또 올해는 이미지나 비디오 생성에서도 뛰어난 발전을 보여줬던 해입니다. 이건 Google 파트에서 더 알아볼게요.
...
Anthropic에서 제일 주요했던 제품은 역시 Claude Code였습니다.
오늘의 세션에서 제일 전달 드리고 싶은 내용이기도 한데요.

저는 일을 할 때 모든 작업을 Claude Code로 하고 있어요.
어떤 문서를 작성하거나, 필요한 결과물을 만들 때 적극 활용하고 있습니다.
...
### OpenAI
Codex MCP 사용, 일상에서 언어 공부할 때, Voice Mode는 OpenAI가 젤 잘하는 듯.
